...
class Easy_Rents_Activator {
	...
	public static function activate() {
		...
		$prelocations = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}easy_rents_prelocations ( `ID` INT NOT NULL AUTO_INCREMENT , `division` VARCHAR(500) NOT NULL, `district` VARCHAR(500) NOT NULL, `p_station` VARCHAR(500) NOT NULL, `create_at` DATETIME NOT NULL, PRIMARY KEY (`ID`)) ENGINE = InnoDB";

		$refer_codes = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}easy_rents_refer_codes ( `ID` INT NOT NULL AUTO_INCREMENT , `refer_code` VARCHAR(20) NOT NULL, PRIMARY KEY (`ID`)) ENGINE = InnoDB";
		
		$ertrips = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}easy_rents_trips ( `ID` INT NOT NULL AUTO_INCREMENT , `user_id` INT NOT NULL , `post_id` INT NOT NULL,`location_1` VARCHAR(255) NOT NULL, `location_2` VARCHAR(255) NOT NULL,`location_3` VARCHAR(255) NOT NULL,`unload_loc` VARCHAR(255) NOT NULL,`goods_type` VARCHAR(50) NOT NULL,`weight` INT NOT NULL,`laborer` INT NOT NULL,`truck_type` VARCHAR(50) NOT NULL,`er_goodssizes` INT NOT NULL, `load_time` VARCHAR(255) NOT NULL,`job_status` VARCHAR(255) NOT NULL, `create_at` DATETIME NOT NULL, PRIMARY KEY (`ID`)) ENGINE = InnoDB";
